...
const ZoneTable = ({
    ...
    // Debug: kiểm tra dữ liệu zones
    console.log('ZoneTable received rows:', rows);
    if (rows && rows.length > 0) {
        console.log('First zone sample:', rows[0]);
        console.log('Store names:', rows.map(z => z.storeName));
    }
