    ...
    return (
        <Box sx={{
            ...
            <Box sx={{
                ...
                {userRole === "STAFF" && (
                    <Chip label={userStoreName} color="primary"
                          sx={{fontWeight: 600, fontSize: 16, height: 32, mt: isMobile ? 1 : 0}}/>
                )}
            </Box>
            <Typography variant="subtitle1" mb={3} color="text.secondary">
                Quản lý và theo dõi các phiếu kiểm kê
            </Typography>
            ...
            <Box sx={{flexDirection: 'column', display: 'flex', gap: 2, mb: 2}}>
                ...
                <Box sx={{display: 'flex', justifyContent: 'flex-end', mt: isMobile ? 2 : 0}}>
                    ...
                    {/* ❌ Ẩn nút Export nếu chưa dùng (mục 5)
          <Button variant="outlined" sx={{ml:2}}>Export Excel</Button>
          */}
                </Box>
            </Box>
